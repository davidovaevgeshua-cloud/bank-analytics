...
4. Пересобираем form102/index.html.
...
def main():
    ...
    if processed:
        ...
        save_state(state)
        out = render(HISTORY_PATH, ROOT / "scripts" / "report_template.html", ROOT / "form102" / "index.html")
        print(f"Обновлены периоды: {processed}. Страница form102/index.html пересобрана: {out}")
    else:
